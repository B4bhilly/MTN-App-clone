...
const HomeScreen = ({navigation}) => {
  ...
  const handleNavigationToAirtime = () =>{
        navigation.navigate('DBNavigator');
    };
            ...
            <ScrollView showsVerticalScrollIndicator={false} >
                <View>
                    ...
                    <View style={{padding:10, flexDirection:'row'}}>
                        <TouchableOpacity onPress={handleNavigationToAirtime} style={styles.tab}>
                            ...
                            <View style={styles.tab1}>
                                ...
                                <Text style={{fontWeight:'bold', fontSize:10, paddingTop:5}}>BONUS :</Text>
                            </View>
                        </TouchableOpacity>

                        <TouchableOpacity onPress={handleNavigationToData} style={styles.tab}>
                            <View style={{marginBottom:'auto'}}>
                                <View style={styles.hi}>
                            ...
                            <View style={styles.tab1}>
                                <View style={styles.mid}>
                                    <Text style={{fontWeight:'bold',fontSize:18,}}>12.90GB</Text>   
                                </View>
                                <Text style={{fontWeight:'bold', fontSize:10, paddingTop:5}}>BONUS :</Text>
                            </View>
                        </TouchableOpacity>
                    ...
                    <View style={{padding:10, flexDirection:'row'}}>
                        <TouchableOpacity onPress={handleNavigationToSMS} style={styles.tab}>
                            <View style={{marginBottom:'auto'}}>
                                <View style={styles.hi}>
                            ...
                            <View style={styles.tab1}>
                                <View style={styles.mid}>
                                    <Text style={{fontWeight:'bold',fontSize:18,}}>4,533 SMS</Text>
                                </View>
                                <Text style={{fontWeight:'bold', fontSize:10, paddingTop:5}}>BONUS :</Text>
                            </View>
                        </TouchableOpacity>
                        ...
                        <TouchableOpacity style={styles.tab}>
                            ...
                            <View style={styles.tab1}>
                                <View style={styles.mid}>
                                    <Text style={{fontWeight:'bold',fontSize:15,}}>GET CONNECTED</Text>
                                </View>
                                <Text style={{fontWeight:'bold', fontSize:10, paddingTop:5}}>CLICK HERE</Text>
                            </View>
                        </TouchableOpacity>
                    </View>
                    <View style={styles.txt}>
                        <Text style={styles.text}>Showing balances as at {currentDateTime}</Text>
                    </View>
                </View>
                <View style={styles.body1}>
                    ...
                    <View>
                        <View style={styles.man}>
                            <TouchableOpacity onPress={handleNavigationToBundle} style={styles.black}>
                        ...
                        <View style={styles.man1}>
                            <TouchableOpacity style={styles.black}>
                                <FontAwesome6 name="circle-dollar-to-slot" size={24} color="white" />
                        ...
                        <View style={{padding:10}}>
                            <Text style={{fontSize:18,paddingLeft:10}}>Popular Bundle</Text>
                        </View>
