    ...
    <View style={styles.container}>
      ...
      <View style={styles.tabContainer}>
        <ScrollView horizontal={true} contentContainerStyle={styles.tabBar}>
          <TouchableOpacity onPress={() => setSelectedTab('Airtime')} style={[styles.tab, selectedTab === 'Airtime' && styles.activeTab]}>
          ...
          <TouchableOpacity onPress={() => setSelectedTab('Voice')} style={[styles.tab, selectedTab === 'Voice' && styles.activeTab]}>
